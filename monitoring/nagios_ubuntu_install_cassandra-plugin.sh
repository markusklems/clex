...
# sudo parallel-ssh -h $HOSTS_FILE -l $USER -o /tmp/nagios-cassandra-plugin "sudo apt-get install -y libwww-perl libjson-perl; git clone git://github.com/causes/cassandra-nagios.git /home/cassandra-nagios; export PERL5LIB=/home/cassandra-nagios/plugins"
